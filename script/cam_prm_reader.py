...
rospy.set_param('/rovi/right/' + NODE_NM + '/K', to_mat_array(ycam_params_l['K'], mat_K_rows, mat_K_cols))
...
rospy.set_param('/rovi/right/' + NODE_NM + '/D_Rows', ycam_params_l['mat_D_rows'])
rospy.set_param('/rovi/right/' + NODE_NM + '/D_Cols', ycam_params_l['mat_D_cols'])
rospy.set_param('/rovi/right/' + NODE_NM + '/D', to_mat_array(ycam_params_l['D'], ycam_params_l['mat_D_rows'], ycam_params_l['mat_D_cols']))
